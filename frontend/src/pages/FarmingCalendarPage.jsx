...
const FarmingCalendarPage = () => {
  ...
  let generateEvents = () => {
    ...
    eventData.push({
      ...
      StartTime: new Date(
        "Sun Sep 29 2024 8:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      EndTime: new Date(
        "Sun Sep 29 2024 9:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      Location: "",
      Description:
        "Distribute feed to animals according to their needs and schedules.",
      RecurrenceRule:
        "FREQ=WEEKLY;BYDAY=SU,MO,TU,WE,TH,FR,SA;INTERVAL=1;COUNT=10;",
      IsAllDay: false,
      IsReadonly: false,
      CalendarId: 1,
    });
    eventData.push({
      ...
      EndTime: new Date(
        "Sun Sep 29 2024 10:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      Location: "",
      Description: "Ensure fresh water is available for all animals.",
      RecurrenceRule:
        "FREQ=WEEKLY;BYDAY=SU,MO,TU,WE,TH,FR,SA;INTERVAL=1;COUNT=10;",
      IsAllDay: false,
      IsReadonly: false,
    ...
    eventData.push({
      Id: 3,
      Subject: "Cleaning up after animals",
      StartTime: new Date(
        "Sun Sep 29 2024 10:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      EndTime: new Date(
        "Sun Sep 29 2024 11:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      Location: "",
      Description:
        "Clean up after animals, including removing waste and cleaning feeding areas.",
      RecurrenceRule:
        "FREQ=WEEKLY;BYDAY=SU,MO,TU,WE,TH,FR,SA;INTERVAL=1;COUNT=10;",
      IsAllDay: false,
      IsReadonly: false,
    ...
    eventData.push({
      ...
      StartTime: new Date(
        "Sun Sep 29 2024 12:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      EndTime: new Date(
        "Sun Sep 29 2024 13:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      Location: "",
      Description:
        "Check irrigation systems and adjust water levels as needed.",
      RecurrenceRule: "FREQ=WEEKLY;BYDAY=SU,TU,TH;INTERVAL=1;COUNT=10;",
      IsAllDay: false,
      IsReadonly: false,
      CalendarId: 1,
    });
    eventData.push({
      Id: 4,
      Subject: "Weeding and pest control",
      StartTime: new Date(
        "Sun Sep 29 2024 12:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      EndTime: new Date(
      ...
      Description:
        "Check irrigation systems and adjust water levels as needed.",
      RecurrenceRule: "FREQ=WEEKLY;BYDAY=SA,MO,WE;INTERVAL=1;COUNT=10;",
      IsAllDay: false,
      IsReadonly: false,
      CalendarId: 1,
    });
    eventData.push({
      ...
      EndTime: new Date(
        "Sun Sep 29 2024 14:00:00 GMT+0600 (Bangladesh Standard Time"
      ),
      Location: "",
      Description: "Monitor crops for signs of stress, disease, or pests.",
      RecurrenceRule: "FREQ=WEEKLY;BYDAY=FR;INTERVAL=1;COUNT=10;",
      IsAllDay: false,
      IsReadonly: false,
      CalendarId: 1,
    });
